...
const TheAlert = ({message, color, actiontype, isDispatch = true}) => {
    ...
    return (
        <div className={`bg-${color}-100 border border-${color}-400 text-${color}-700 px-4 py-3 mb-2 rounded relative`} role="alert">
            ...
            <span className="absolute top-0 bottom-0 right-0 px-4 py-3" onClick={() => isDispatch ? dispatch({type: actiontype}) : dispatch(actiontype())}>
