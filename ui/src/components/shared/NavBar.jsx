        ...
        <header className="lg:px-16 px-6 bg-white flex flex-wrap items-center py-2 border-b">
            <div className="flex-1 flex justify-between items-center">
                <Link className="flex items-center" to="/">
                    ...
                    <span className="text-teal-600 uppercase font-semibold text-lg">Dev Insights</span>
                </Link>
            </div>
            <button onClick={() => setToggle(!toggle)} className="lg:hidden block border border-gray-400 p-1 rounded hover:border-gray-900">
                {!toggle && <svg className="fill-current text-gray-900" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><title>menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"></path></svg>}
                {toggle && <span className='p-1'>X</span>}
            </button>
